...
Contributors: playes
Donate link: http://www.xiaomac.com/201311150.html
...
可用国内社交网站：腾讯QQ、新浪微博、百度、豆瓣、人人网、开心网、小米、CSDN、OSChina、微信绑定登录或分享的一个插件。
...
1、免费版本功能完善稳定，会停止更新
2、为了保持积极负责的态度，会继续开发付费版
3、Open Social Air: RMB 10
4、Open Social Pro: RMB 50
...
通常是第三方设置的回调地址设置问题所致。注意：要跟网站域名一致，并且末尾要保留斜杆。
