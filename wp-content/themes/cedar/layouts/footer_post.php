	...
	<footer class="postinfo">
		<div class="default">
			...
			<section class="authorinfo"> 
				<a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>" class="authorname"><img src="//0.gravatar.com/avatar/<?php echo esc_attr(md5(get_the_author_meta('user_email'))); ?>?s=24" class="gravatar" alt="<?php the_author(); ?>"> <?php the_author(); ?></a><span class="authordate"><?php esc_html_e('Posted on', 'cedar'); ?> <?php echo esc_html(ecko_date_format()); ?></span>
			</section>
